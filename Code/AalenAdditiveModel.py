...
'''This module contains the basicz functions for
    ...
    3. Using the trained bootstrap models to predict the lifetime ('Total_years') of users.
...
def plot_user_cum_haz(user_cum_haz_functions_list, number_of_users = 8, years = 5, y_max = 5, lw = 0.01):
	...
	randomly selects number_of_users (censored), and plots their hazard functions.

    Parameters:
	'Total_years' represents how many years the users have been active.
	'censored' indicates whether a user is still active (True = active user).
	...
	text = 'Cumulative hazards for ' + str(number_of_users) + ' random censored users.'
